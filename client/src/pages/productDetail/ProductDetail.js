        ...
        <div className='product-layout'>
          ...
          <div className='product-info'>
            ...
            <div className='return-policy'>
              <ul>
                <li>
                  This product is made to order and is typically printed to 3-6 days. Your entire order will ship out together.  
 </li>
                <li> Since this product is printed on demand especially for you,it is not eligible for.
                  it is not eligible for cancellations and returns.Read our Return Policy.</li>
              </ul>
